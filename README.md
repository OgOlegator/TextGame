...
Для добавления новых действий их надо завести в этом файле и указать класс реализующий логику действия в игре (Class Namespace.Class Name). Классы-обработчики действий должны реализовывать тип BaseActionHandler.
